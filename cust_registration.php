...
if(isset($_POST['btn-signup']))
{
    ...
    $upref = mysqli_real_escape_string($con,$_POST['sel']);
	
	if(mysqli_query($con,"INSERT INTO customer(uname,email,pass,preference) VALUES('$uname','$uemail','$upass','$upref')"))
	{
        ?>
...
<main class="login-form">
    <div class="cotainer">
    <center><h1 class="h1-title">Customer Registration</h1></center>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="unm" class="form-control" name="unm" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 offset-md-4">
                               ...
                               <br> 
                               <h6>
                                    Already have Account?&nbsp; <button type="button" class="btn btn-primary" onclick="window.location.href = 'cust_login.php';">Login</button>
                                </h6>
                            </div>
                    </div>
                    </form>
