...
if(isset($_POST['btn-login']))
{
	...
	$res=mysqli_query($con,"SELECT * FROM customer WHERE email='$uemail'");
	$row=mysqli_fetch_array($res);
	
	if($row['pass']==md5($upass))
	{
...
<main class="login-form">
    <div class="cotainer">
    <center><h1 class="h1-title">Customer Login</h1></center>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="col-md-6 offset-md-4">
                                ...
                                <br>
                                <h6>
                                    New Here? &nbsp; <button type="button" class="btn btn-primary" onclick="window.location.href = 'cust_registration.php';">Register</button>
                                </h6>
                            </div>
                    </div>
                    </form>
